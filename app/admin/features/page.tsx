...
import { Plus, Edit2, Trash2, Sparkles, Link2, Upload, X, FileSpreadsheet } from 'lucide-react';
...
export default function FeaturesPage() {
  ...
  const handleExcelUpload = async () => {
    ...
    try {
      ...
      const response = await authenticatedFetch('/api/admin/features/upload-excel', {
        method: 'POST',
        body: formData,
      });
      ...
      if (data.success) {
        ...
        showToast('success', `Successfully processed ${data.data.created + data.data.updated} features`);
        setExcelFile(null);
  ...
  return (
    <div className="w-full min-w-0 max-w-full">
      ...
      <Modal
        ...
        title="Upload Features from Excel"
        size="lg"
        footer={
          <>
            <Button
        ...
        <div className="space-y-4">
          <div>
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
              Upload an Excel file (.xlsx, .xls, or .csv) to create or update features in bulk.
            </p>
            
            <div className="mb-4">
              <a
                href="/features-template.xlsx"
                download
            ...
            <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              ...
              <ul className="text-xs text-blue-800 dark:text-blue-300 space-y-1 list-disc list-inside">
                <li><strong>code</strong> - Feature code (e.g., F12, F13) - Must start with F followed by digits</li>
                <li><strong>name</strong> - Feature name</li>
                <li><strong>category</strong> - One of: DURABILITY, COATING, PROTECTION, LIFESTYLE, VISION</li>
              </ul>
              ...
              <ul className="text-xs text-blue-800 dark:text-blue-300 space-y-1 list-disc list-inside">
                ...
                <li><strong>displayOrder</strong> - Display order (number)</li>
                <li><strong>iconUrl</strong> - Icon URL</li>
              </ul>
            </div>
