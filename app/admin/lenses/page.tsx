  ...
  return (
    <div>
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Lenses</h1>
          <p className="text-sm sm:text-base text-slate-600 mt-1">Manage lens products</p>
        </div>
        <Button onClick={() => router.push('/admin/lenses/new')} className="w-full sm:w-auto">
